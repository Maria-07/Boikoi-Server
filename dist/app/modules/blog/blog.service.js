...
// get all Blogs
const getAllBlog = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateBlog = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.Blog.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
...
const deleteBlog = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.Blog.findByIdAndDelete(
      { _id: id },
      { new: true }
    );
    return result;
...
// add Comment
const AddBlogComment = (blogId, comments) =>
  __awaiter(void 0, void 0, void 0, function* () {
