...
const createShop = shopData =>
  __awaiter(void 0, void 0, void 0, function* () {
    const bookShopOwnerDetails = yield user_model_1.User.findById(
      shopData.bookShopOwner
    );
    ...
    const isExist = yield shop_model_1.Shop.findOne({
      bookShopOwner: shopData.bookShopOwner,
    });
...
// get all Shops
const getAllShop = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleShop = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield shop_model_1.Shop.findById(id).populate(
      'bookShopOwner'
    );
    return result;
  });
// updated Shop
const updateShop = (id, payload, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     );
    //   }
    const result = yield shop_model_1.Shop.findOneAndUpdate(
      { _id: id },
      payload,
      {
        new: true,
...
const deleteShop = (id, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    //     );
    //   }
    const result = yield shop_model_1.Shop.findByIdAndDelete(
      { _id: id },
      { new: true }
    );
