...
const createOrder = order =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      (BuyerDetails === null || BuyerDetails === void 0
        ? void 0
        : BuyerDetails.role) !== 'buyer'
    ) {
      throw new ApiError_1.default(
        http_status_1.default.NOT_FOUND,
        'This user is not a buyer'
      );
    }
    ...
    try {
      ...
      yield cow_model_1.Cow.updateOne(
        { _id: CowDetails.id },
        { $set: { label: 'sold out' } }
      );
      ...
      if (sellerData) {
        const sellerIncomeUpdate = {
          income:
            (sellerData === null || sellerData === void 0
              ? void 0
...
const getSingleOrder = (id, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (role === 'buyer') {
      const buyerID =
        order === null || order === void 0 ? void 0 : order.buyer.toString();
    ...
    if (role === 'seller') {
      const CowDetails = yield cow_model_1.Cow.findById(
        order === null || order === void 0 ? void 0 : order.cow
      );
      const SellerID =
        CowDetails === null || CowDetails === void 0
          ? void 0
          : CowDetails.seller.toString();
