...
const getAllCow = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm, maxPrice, minPrice } = filters,
      filtersData = __rest(filters, ['searchTerm', 'maxPrice', 'minPrice']);
    const andCondition = [];
    if (searchTerm) {
      andCondition.push({
...
const updateCow = (id, payload, token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const sellerDetails = yield user_model_1.User.findById(
      cowDetails === null || cowDetails === void 0 ? void 0 : cowDetails.seller
    );
    // console.log('👉👉👉👉👉👉sellerDetails', sellerDetails);
    if (
      (sellerDetails === null || sellerDetails === void 0
        ? void 0
        : sellerDetails.phoneNumber) !== phone ||
      (sellerDetails === null || sellerDetails === void 0
        ? void 0
        : sellerDetails.role) !== role
    ) {
      throw new ApiError_1.default(
        http_status_1.default.NOT_FOUND,
